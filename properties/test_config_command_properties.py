...
@given(pyproject_present=st.booleans())
def test_config_state_without_config_never_reports_resolved(pyproject_present: bool) -> None:
    assert _config_state(None, pyproject_present=pyproject_present) in {"missing", "unreadable"}
