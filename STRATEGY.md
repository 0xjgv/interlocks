...
3. Shared automation uses pinned or range-pinned specs: `uvx --from 'interlocks>=0.2,<0.3' il ci`, exact `uvx --from interlocks==0.2.0 il ci`, or the GitHub Action `install-command` override.
